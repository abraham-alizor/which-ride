			...
			<div className='flex flex-col items-center mt-16 mb-16 max-w-full w-[842px] max-md:my-10'>
				...
				<div className='hidden md:block'>
					<Fade
						...
						cascade
						duration={50}
						className='mt-11 text-xl font-medium tracking-normal leading-8 text-center text-neutral-200 max-md:mt-10 max-md:max-w-full'
					>
					...
					<Fade
						...
						cascade
						duration={50}
						className=' text-xl font-medium tracking-normal leading-8 text-center text-neutral-200  max-md:max-w-full'
					>
